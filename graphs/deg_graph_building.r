library(jsonlite)
opt_data <- fromJSON("deg_space_results.json")
...
png("deg_uniform_random.png", width = 800, height = 600)
...
# SORTED
################################################################
png("deg_sorted.png", width = 800, height = 600)
Sorted_opt <- opt_data[opt_data$input_data_type == "Sorted", ]
Sorted_opt$average <- sapply(Sorted_opt$durations, mean)
...
# REVSORTED
################################################################
png("deg_reverse_sorted.png", width = 800, height = 600)
...
# Almost Sorted
################################################################
png("deg_almost_sorted.png", width = 800, height = 600)
...
# Pipe Organ
################################################################
png("deg_pipe_organ.png", width = 800, height = 600)
